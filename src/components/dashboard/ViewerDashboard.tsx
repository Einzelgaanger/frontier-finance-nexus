...
const ViewerDashboard = () => {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 min-h-screen space-y-6">
        {/* Welcome Section */}
        <div className="text-center">
          <h1 className="text-3xl font-bold text-black mb-3">Welcome to the ESCP Network</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <Card className="border-green-300 bg-white/80 hover:shadow-lg transition-shadow min-h-[180px] flex flex-col justify-between">
            <CardHeader>
          ...
          {/* Access Level Info */}
          <Card className="border-blue-200 bg-white/80 flex flex-col justify-between min-h-[180px]">
            <CardHeader>
              <CardTitle className="text-lg font-semibold flex items-center">
            ...
            <CardContent>
              <div className="space-y-2 mb-4">
                <div className="flex items-center text-blue-800 text-base">
