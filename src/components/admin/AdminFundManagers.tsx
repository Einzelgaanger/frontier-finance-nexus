...
const AdminFundManagers = () => {
  ...
  const fetchFundManagers = useCallback(async () => {
    try {
      setLoading(true);
      console.log('Fetching fund managers data...');
      ...
      toast({
        title: "Error",
        description: "Failed to fetch fund managers data. Please try again.",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  // Calculate fund manager statistics
  const fundManagerStats = useMemo(() => {
    ...
    const activeManagers = fundManagers.filter(m => m.role_badge === 'member').length;
  ...
  const quickActions = [
    ...
    { icon: Plus, label: 'Add Manager', action: () => console.log('Add manager') }
  ];
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Loading Fund Managers</h2>
          <p className="text-gray-600">Fetching manager data...</p>
        </div>
      </div>
    );
  }
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-purple-100 text-lg font-medium">
                      Manage and monitor fund managers in the network
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-6">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm font-medium">{fundManagerStats.totalManagers} Total Managers</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Target className="w-5 h-5 text-cyan-300" />
                    <span className="text-sm font-medium">{fundManagerStats.completionRate}% Completion Rate</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Globe className="w-5 h-5 text-green-300" />
                    <span className="text-sm font-medium">{fundManagerStats.topRegions} Global Regions</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <p className="text-sm font-semibold text-blue-700">Total Managers</p>
                  </div>
                  <p className="text-3xl font-bold text-blue-900">{fundManagerStats.totalManagers}</p>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div className="space-y-2">
                  ...
                  <p className="text-3xl font-bold text-green-900">{fundManagerStats.completionRate}%</p>
                  <div className="flex items-center space-x-1">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div className="space-y-2">
                  ...
                  <p className="text-3xl font-bold text-purple-900">{fundManagerStats.topRegions}</p>
                  <div className="flex items-center space-x-1">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <p className="text-sm font-semibold text-orange-700">Active Managers</p>
                  </div>
                  <p className="text-3xl font-bold text-orange-900">{fundManagerStats.activeManagers}</p>
                  <div className="flex items-center space-x-1">
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-semibold text-gray-900">{fundManagerStats.completionRate}%</span>
                    </div>
                    <Progress value={fundManagerStats.completionRate} className="h-2" />
                  </div>
                  
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-gray-600">Active Managers</span>
                      <span className="text-sm font-semibold text-gray-900">{fundManagerStats.activeManagers}</span>
                    </div>
                    <Progress value={(fundManagerStats.activeManagers / fundManagerStats.totalManagers) * 100} className="h-2" />
                  </div>
                  
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-gray-600">Global Coverage</span>
                      <span className="text-sm font-semibold text-gray-900">{fundManagerStats.topRegions} regions</span>
                    </div>
                    <Progress value={(fundManagerStats.topRegions / 10) * 100} className="h-2" />
                  </div>
                </CardContent>
              </Card>
                ...
                <div className="flex flex-col lg:flex-row gap-4">
                  <div className="flex-1">
                    <div className="relative">
                      ...
                      <Input
                        placeholder="Search managers, funds, or regions..."
                        value={searchTerm}
          ...
          <TabsContent value="analytics" className="space-y-6">
            <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardDescription>
                  Comprehensive analytics and insights about fund managers
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-6 max-w-md mx-auto">
                    Detailed analytics and insights about fund manager performance, investment patterns, and network growth.
                  </p>
                  <Button 
          ...
          <TabsContent value="management" className="space-y-6">
            <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardDescription>
                  Administrative tools and fund manager management features
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-6 max-w-md mx-auto">
                    Access administrative tools for managing fund managers, permissions, and system settings.
                  </p>
                  <Button 
                    onClick={() => setActiveTab('managers')}
