      ...
      <section className="relative min-h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url(/CFF.jpg)' }}>
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-2xl md:text-3xl text-white/95 mb-4 max-w-4xl mx-auto font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Link to="/auth">
                <Button 
                  size="lg" 
                  className="group bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-10 py-6 text-lg font-semibold shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 rounded-full"
                >
              ...
              <Link to="/network">
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="group border-2 border-white/30 text-white hover:bg-white/20 hover:border-white/50 bg-white/5 backdrop-blur-md px-10 py-6 text-lg font-semibold shadow-xl hover:shadow-white/10 transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 rounded-full"
                >
                  <div className="flex items-center space-x-3">
         ...
         <section ref={sectionRef} className="relative py-16 overflow-hidden rounded-t-[2.5rem] bg-amber-50 -mt-20">
        {/* Extra padding at the top to compensate for the negative margin */}
        <div className="absolute top-0 left-0 right-0 h-20 bg-amber-50 rounded-t-[2.5rem]"></div>
        ...
        <div className="absolute -bottom-8 left-1/2 w-72 h-72 bg-pink-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>
            ...
            <div className={`grid grid-cols-1 lg:grid-cols-[1fr,1fr] gap-8 mb-12 transition-all duration-[1500ms] ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              {/* Title and Content on the Left */}
              <div className="order-1 lg:order-1 flex flex-col justify-center -mt-20">
              ...
              <div className="order-2 lg:order-2">
                <div className="relative bg-white/80 backdrop-blur-lg rounded-3xl p-0 shadow-2xl border border-white/20 overflow-hidden group hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2">
             ...
             <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 -mt-12">
              ...
              <div className="space-y-6">
                ...
                <div className={`transition-all duration-[1500ms] delay-300 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                  <div className="relative bg-white/80 backdrop-blur-lg rounded-3xl p-0 shadow-xl border border-white/20 overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
              ...
              <div className={`mt-12 transition-all duration-[1500ms] delay-400 ease-out ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                <h3 className="text-3xl font-bold text-gray-900 mb-4">
                  The Challenge
                </h3>
                <p className="text-base text-gray-700 leading-relaxed mb-3">
                  Small and growing businesses create roughly <span className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600">80%</span> of formal employment in frontier markets, yet face an estimated <span className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-600">$940 billion</span> financing gap.
                </p>
