-- Update survey fields: add how_heard_about_network_other and remove information_sharing

-- Add the new field for "other" explanation
ALTER TABLE public.survey_responses ADD COLUMN IF NOT EXISTS how_heard_about_network_other TEXT;

-- Remove the information_sharing field (we'll drop it if it exists)
ALTER TABLE public.survey_responses DROP COLUMN IF EXISTS information_sharing;
