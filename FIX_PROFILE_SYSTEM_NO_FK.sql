-- =====================================================
-- FIX PROFILE SYSTEM WITHOUT FOREIGN KEY CONSTRAINTS
-- =====================================================
-- This script creates user_profiles table without foreign key constraints
-- and populates it from user_backup for ALL users
-- =====================================================

-- Step 1: Drop existing user_profiles table if it exists
DROP TABLE IF EXISTS public.user_profiles CASCADE;

-- Step 2: Create user_profiles table WITHOUT foreign key constraint
